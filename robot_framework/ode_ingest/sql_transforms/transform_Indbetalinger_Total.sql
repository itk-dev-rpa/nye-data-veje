    ...
    -- ============================================================
    -- Pipeline Script for Indbetalinger (Total)
    -- Source:  Indbetalinger_Total_Staging
    -- Targets: Indbetalinger_Total_Backup, Indbetalinger_Total_Typed, Indbetalinger
    ...
    IF OBJECT_ID('[ode].[Indbetalinger_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Indbetalinger_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[Indbetalinger_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Indbetalinger_Total_Typed] (
    ...
    INSERT INTO [ode].[Indbetalinger_Total_Backup] (
        [Afdeling],
    [Afklaringsstatus],
    [Aftale],
    [Aftalekonto],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[Indbetalinger_Total_Staging];
    ...
    INSERT INTO [ode].[Indbetalinger_Total_Typed] (
        [Afdeling],
    [Afklaringsstatus],
    [Aftale],
    [Aftalekonto],
    ...
    INSERT INTO [ode].[Indbetalinger] ([Afdeling], [Afklaringsstatus], [Aftale], [Aftalekonto], [Annuller_status], [Anvendelsestekst], [Art_kilde], [Bankafregningskonto], [Bankforbindelse], [Beløb], [Betalings_art], [Betalingsidentifikator], [Betalingsmåde], [Betalingsretning], [Bilagsart], [Bilagsnummer], [Firmakode], [Forretningsområde], [Forretningspartner], [Kasse], [Kommune_kode], [Konto-ID], [Langtekst], [Løbenummer], [Oprettet_den], [Skæringsdato], [Stak], [Tidsstempel_for_deltaekstrakt], [Underapplikation], [Valørdato], [Valuta], [Varighed_af_afklaring], [export_date], [file_origin], [row_number], [etl_version])
    SELECT [Afdeling], [Afklaringsstatus], [Aftale], [Aftalekonto], [Annuller_status], [Anvendelsestekst], [Art_kilde], [Bankafregningskonto], [Bankforbindelse], [Beløb], [Betalings_art], [Betalingsidentifikator], [Betalingsmåde], [Betalingsretning], [Bilagsart], [Bilagsnummer], [Firmakode], [Forretningsområde], [Forretningspartner], [Kasse], [Kommune_kode], [Konto-ID], [Langtekst], [Løbenummer], [Oprettet_den], [Skæringsdato], [Stak], [Tidsstempel_for_deltaekstrakt], [Underapplikation], [Valørdato], [Valuta], [Varighed_af_afklaring], [export_date], [file_origin], [row_number], [etl_version] FROM new_data;
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[Indbetalinger_Total_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[Indbetalinger_Total_Staging];
    GO
