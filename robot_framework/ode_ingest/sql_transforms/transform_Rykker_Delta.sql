    ...
    -- ============================================================
    -- Pipeline Script for Rykker (Delta)
    -- Source:  Rykker_Delta_Staging
    -- Targets: Rykker_Delta_Backup, Rykker_Delta_Typed, Rykker
    ...
    IF OBJECT_ID('[ode].[Rykker_Delta_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Rykker_Delta_Backup] (
    ...
    IF OBJECT_ID('[ode].[Rykker_Delta_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Rykker_Delta_Typed] (
    ...
    INSERT INTO [ode].[Rykker_Delta_Backup] (
        [Aftale],
    ...
    INSERT INTO [ode].[Rykker_Delta_Typed] (
        [Aftale],
    [Aftalekonto_ikke_entydig],
    [Aftalekonto],
    [Bilagsnummer],
    ...
    MERGE INTO [ode].[Rykker] AS target
    USING new_data AS source
    ON target.[Dato-ID] = source.[Dato-ID] AND target.[Identifikation] = source.[Identifikation] AND target.[Forretningspartner] = source.[Forretningspartner] AND target.[Aftalekonto] = source.[Aftalekonto] AND target.[Rykkertæller] = source.[Rykkertæller] AND target.[Bilagsnummer] = source.[Bilagsnummer] AND target.[Gentagelsesposition] = source.[Gentagelsesposition] AND target.[Position] = source.[Position] AND target.[Delposition] = source.[Delposition]
    WHEN MATCHED THEN
        UPDATE SET target.[Aftale] = source.[Aftale], target.[Aftalekonto_ikke_entydig] = source.[Aftalekonto_ikke_entydig], target.[Firmakode] = source.[Firmakode], target.[Kommune_kode] = source.[Kommune_kode], target.[Nettoforfald] = source.[Nettoforfald], target.[Nyt_rykkeniveau] = source.[Nyt_rykkeniveau], target.[Printdato] = source.[Printdato], target.[Rentebilag] = source.[Rentebilag], target.[Rykkebeløb] = source.[Rykkebeløb], target.[Rykkeniveau] = source.[Rykkeniveau], target.[Rykkeniveautype] = source.[Rykkeniveautype], target.[Rykkeprocedure] = source.[Rykkeprocedure], target.[Rykker_annulleret] = source.[Rykker_annulleret], target.[Rykkerenter] = source.[Rykkerenter], target.[Rykkespærreårsag] = source.[Rykkespærreårsag], target.[Segment] = source.[Segment], target.[Skæringsdato] = source.[Skæringsdato], target.[Statistiknøgle] = source.[Statistiknøgle], target.[Suspenderings-rykkeniv] = source.[Suspenderings-rykkeniv], target.[Udskrevet] = source.[Udskrevet], target.[Udstedelsesdato] = source.[Udstedelsesdato], target.[Valuta] = source.[Valuta], target.[export_date] = source.[export_date], target.[file_origin] = source.[file_origin], target.[row_number] = source.[row_number], target.[etl_version] = source.[etl_version]
    WHEN NOT MATCHED THEN
        INSERT ([Aftale], [Aftalekonto_ikke_entydig], [Aftalekonto], [Bilagsnummer], [Dato-ID], [Delposition], [Firmakode], [Forretningspartner], [Gentagelsesposition], [Identifikation], [Kommune_kode], [Nettoforfald], [Nyt_rykkeniveau], [Position], [Printdato], [Rentebilag], [Rykkebeløb], [Rykkeniveau], [Rykkeniveautype], [Rykkeprocedure], [Rykker_annulleret], [Rykkerenter], [Rykkertæller], [Rykkespærreårsag], [Segment], [Skæringsdato], [Statistiknøgle], [Suspenderings-rykkeniv], [Udskrevet], [Udstedelsesdato], [Valuta], [export_date], [file_origin], [row_number], [etl_version])
        VALUES (source.[Aftale], source.[Aftalekonto_ikke_entydig], source.[Aftalekonto], source.[Bilagsnummer], source.[Dato-ID], source.[Delposition], source.[Firmakode], source.[Forretningspartner], source.[Gentagelsesposition], source.[Identifikation], source.[Kommune_kode], source.[Nettoforfald], source.[Nyt_rykkeniveau], source.[Position], source.[Printdato], source.[Rentebilag], source.[Rykkebeløb], source.[Rykkeniveau], source.[Rykkeniveautype], source.[Rykkeprocedure], source.[Rykker_annulleret], source.[Rykkerenter], source.[Rykkertæller], source.[Rykkespærreårsag], source.[Segment], source.[Skæringsdato], source.[Statistiknøgle], source.[Suspenderings-rykkeniv], source.[Udskrevet], source.[Udstedelsesdato], source.[Valuta], source.[export_date], source.[file_origin], source.[row_number], source.[etl_version]);
