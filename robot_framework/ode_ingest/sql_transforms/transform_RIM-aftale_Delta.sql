    ...
    -- ============================================================
    -- Pipeline Script for RIM-aftale (Delta)
    -- Source:  RIM-aftale_Delta_Staging
    -- Targets: RIM-aftale_Delta_Backup, RIM-aftale_Delta_Typed, RIM-aftale
    ...
    IF OBJECT_ID('[ode].[RIM-aftale_Delta_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[RIM-aftale_Delta_Backup] (
    ...
    IF OBJECT_ID('[ode].[RIM-aftale_Delta_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[RIM-aftale_Delta_Typed] (
    ...
    INSERT INTO [ode].[RIM-aftale_Delta_Backup] (
    ...
    [row_number],
    [etl_version]
    FROM [ode].[RIM-aftale_Delta_Staging];
    
    GO
    
    
    -- 2. TYPED: Transform and insert (No PK defined)
    INSERT INTO [ode].[RIM-aftale_Delta_Typed] (
        [Åbent_beløb_for_perioden],
    [Ændret_den],
    [Ændringsårsagstekst],
    [Ændringsårsagskode],
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[RIM-aftale_Delta_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[RIM-aftale_Delta_Staging];
    GO
