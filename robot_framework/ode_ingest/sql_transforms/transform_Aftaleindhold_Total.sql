    ...
    -- ============================================================
    -- Pipeline Script for Aftaleindhold (Total)
    -- Source:  Aftaleindhold_Total_Staging
    -- Targets: Aftaleindhold_Total_Backup, Aftaleindhold_Total_Typed, Aftaleindhold
    ...
    IF OBJECT_ID('[ode].[Aftaleindhold_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Aftaleindhold_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[Aftaleindhold_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Aftaleindhold_Total_Typed] (
    ...
    INSERT INTO [ode].[Aftaleindhold_Total_Backup] (
        [Aftaleindhold],
    [Oprettet_af],
    [Oprettet_den],
    [Ændret_af],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[Aftaleindhold_Total_Staging];
    ...
    INSERT INTO [ode].[Aftaleindhold_Total_Typed] (
        [Aftaleindhold],
    [Oprettet_af],
    [Oprettet_den],
    [Ændret_af],
    ...
    INSERT INTO [ode].[Aftaleindhold] ([Aftaleindhold], [Oprettet_af], [Oprettet_den], [Ændret_af], [Ændret_den], [Indholdsart], [Bet_aftaleindhold], [Nummer_i_basissystem], [Kommune_kode], [export_date], [file_origin], [row_number], [etl_version])
    SELECT [Aftaleindhold], [Oprettet_af], [Oprettet_den], [Ændret_af], [Ændret_den], [Indholdsart], [Bet_aftaleindhold], [Nummer_i_basissystem], [Kommune_kode], [export_date], [file_origin], [row_number], [etl_version] FROM new_data;
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[Aftaleindhold_Total_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[Aftaleindhold_Total_Staging];
    GO
