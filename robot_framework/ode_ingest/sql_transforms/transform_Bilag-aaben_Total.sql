    ...
    -- ============================================================
    -- Pipeline Script for Bilag-aaben (Total)
    -- Source:  Bilag-aaben_Total_Staging
    -- Targets: Bilag-aaben_Total_Backup, Bilag-aaben_Total_Typed, Bilag-aaben
    ...
    IF OBJECT_ID('[ode].[Bilag-aaben_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-aaben_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[Bilag-aaben_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-aaben_Total_Typed] (
    ...
    INSERT INTO [ode].[Bilag-aaben_Total_Backup] (
        [Aftaleindhold],
    [Aftalekonto],
    [Aftalekontotype],
    [Aftalenummer],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[Bilag-aaben_Total_Staging];
    
    GO
    
    
    -- 2. TYPED: Transform and insert (No PK defined)
    INSERT INTO [ode].[Bilag-aaben_Total_Typed] (
        [Aftaleindhold],
    [Aftalekonto],
    [Aftalekontotype],
    [Aftalenummer],
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[Bilag-aaben_Total_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[Bilag-aaben_Total_Staging];
    GO
