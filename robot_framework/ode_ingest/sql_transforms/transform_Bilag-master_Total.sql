    ...
    -- ============================================================
    -- Pipeline Script for Bilag-master (Total)
    -- Source:  Bilag-master_Total_Staging
    -- Targets: Bilag-master_Total_Backup, Bilag-master_Total_Typed, Bilag-master
    ...
    IF OBJECT_ID('[ode].[Bilag-master_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-master_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[Bilag-master_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-master_Total_Typed] (
    ...
    INSERT INTO [ode].[Bilag-master_Total_Backup] (
        [Gentagelsesposition],
    [AfregnPeriode_fra],
    [AfregnPeriode_til],
    [Afskrivningsårsag],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[Bilag-master_Total_Staging];
    ...
    INSERT INTO [ode].[Bilag-master_Total_Typed] (
        [Gentagelsesposition],
    [AfregnPeriode_fra],
    [AfregnPeriode_til],
    [Afskrivningsårsag],
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[Bilag-master_Total_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[Bilag-master_Total_Staging];
    GO
