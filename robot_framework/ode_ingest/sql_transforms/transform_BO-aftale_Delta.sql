    ...
    -- ============================================================
    -- Pipeline Script for BO-aftale (Delta)
    -- Source:  BO-aftale_Delta_Staging
    -- Targets: BO-aftale_Delta_Backup, BO-aftale_Delta_Typed, BO-aftale
    ...
    IF OBJECT_ID('[ode].[BO-aftale_Delta_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[BO-aftale_Delta_Backup] (
    ...
    IF OBJECT_ID('[ode].[BO-aftale_Delta_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[BO-aftale_Delta_Typed] (
    ...
    INSERT INTO [ode].[BO-aftale_Delta_Backup] (
        [Aftalestatus],
    [Aftaletype],
    [Aftalenummer],
    [Bilagsnummer],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[BO-aftale_Delta_Staging];
    ...
    INSERT INTO [ode].[BO-aftale_Delta_Typed] (
        [Aftalestatus],
    [Aftaletype],
    [Aftalenummer],
    [Bilagsnummer],
    ...
    MERGE INTO [ode].[BO-aftale] AS target
    USING new_data AS source
    ON target.[Aftalenummer] = source.[Aftalenummer] AND target.[Bilagsnummer] = source.[Bilagsnummer] AND target.[Position] = source.[Position]
    WHEN MATCHED THEN
        UPDATE SET target.[Aftalestatus] = source.[Aftalestatus], target.[Aftaletype] = source.[Aftaletype], target.[Oprettet_beløb] = source.[Oprettet_beløb], target.[Valuta] = source.[Valuta], target.[Første_anmeldelse] = source.[Første_anmeldelse], target.[Indbetalt_af_bobestyrer] = source.[Indbetalt_af_bobestyrer], target.[Fjernet] = source.[Fjernet], target.[Bobehandling] = source.[Bobehandling], target.[Indholdsart] = source.[Indholdsart], target.[Deltransaktion] = source.[Deltransaktion], target.[Hovedtransaktion] = source.[Hovedtransaktion], target.[Aftalekonto] = source.[Aftalekonto], target.[Aftale] = source.[Aftale], target.[Kommune_kode] = source.[Kommune_kode], target.[Restbeløb] = source.[Restbeløb], target.[Afskrevet] = source.[Afskrevet], target.[Ændringer_efter_første_anmeld] = source.[Ændringer_efter_første_anmeld], target.[export_date] = source.[export_date], target.[file_origin] = source.[file_origin], target.[row_number] = source.[row_number], target.[etl_version] = source.[etl_version]
    WHEN NOT MATCHED THEN
        INSERT ([Aftalestatus], [Aftaletype], [Aftalenummer], [Bilagsnummer], [Position], [Oprettet_beløb], [Valuta], [Første_anmeldelse], [Indbetalt_af_bobestyrer], [Fjernet], [Bobehandling], [Indholdsart], [Deltransaktion], [Hovedtransaktion], [Aftalekonto], [Aftale], [Kommune_kode], [Restbeløb], [Afskrevet], [Ændringer_efter_første_anmeld], [export_date], [file_origin], [row_number], [etl_version])
        VALUES (source.[Aftalestatus], source.[Aftaletype], source.[Aftalenummer], source.[Bilagsnummer], source.[Position], source.[Oprettet_beløb], source.[Valuta], source.[Første_anmeldelse], source.[Indbetalt_af_bobestyrer], source.[Fjernet], source.[Bobehandling], source.[Indholdsart], source.[Deltransaktion], source.[Hovedtransaktion], source.[Aftalekonto], source.[Aftale], source.[Kommune_kode], source.[Restbeløb], source.[Afskrevet], source.[Ændringer_efter_første_anmeld], source.[export_date], source.[file_origin], source.[row_number], source.[etl_version]);
