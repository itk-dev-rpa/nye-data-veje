    ...
    -- ============================================================
    -- Pipeline Script for UU-aftale (Delta)
    -- Source:  UU-aftale_Delta_Staging
    -- Targets: UU-aftale_Delta_Backup, UU-aftale_Delta_Typed, UU-aftale
    ...
    IF OBJECT_ID('[ode].[UU-aftale_Delta_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[UU-aftale_Delta_Backup] (
    ...
    IF OBJECT_ID('[ode].[UU-aftale_Delta_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[UU-aftale_Delta_Typed] (
    ...
    INSERT INTO [ode].[UU-aftale_Delta_Backup] (
        [Aftalestatus],
    [Aftaletype],
    [Aftalenummer],
    [Indholdsart],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[UU-aftale_Delta_Staging];
    
    GO
    
    
    -- 2. TYPED: Transform and insert (No PK defined)
    INSERT INTO [ode].[UU-aftale_Delta_Typed] (
        [Aftalestatus],
    [Aftaletype],
    [Aftalenummer],
    [Indholdsart],
