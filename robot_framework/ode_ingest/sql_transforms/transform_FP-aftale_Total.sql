    ...
    -- ============================================================
    -- Pipeline Script for FP-aftale (Total)
    -- Source:  FP-aftale_Total_Staging
    -- Targets: FP-aftale_Total_Backup, FP-aftale_Total_Typed, FP-aftale
    ...
    IF OBJECT_ID('[ode].[FP-aftale_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[FP-aftale_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[FP-aftale_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[FP-aftale_Total_Typed] (
    ...
    INSERT INTO [ode].[FP-aftale_Total_Backup] (
        [AA_type],
    [Ændret_den],
    [Aftale],
    [Aftalekonto],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[FP-aftale_Total_Staging];
    
    GO
    
    
    -- 2. TYPED: Transform and insert (No PK defined)
    INSERT INTO [ode].[FP-aftale_Total_Typed] (
        [AA_type],
    [Ændret_den],
    [Aftale],
    [Aftalekonto],
