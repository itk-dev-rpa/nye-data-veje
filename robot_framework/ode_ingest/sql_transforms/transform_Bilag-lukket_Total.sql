    ...
    -- ============================================================
    -- Pipeline Script for Bilag-lukket (Total)
    -- Source:  Bilag-lukket_Total_Staging
    -- Targets: Bilag-lukket_Total_Backup, Bilag-lukket_Total_Typed, Bilag-lukket
    ...
    IF OBJECT_ID('[ode].[Bilag-lukket_Total_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-lukket_Total_Backup] (
    ...
    IF OBJECT_ID('[ode].[Bilag-lukket_Total_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[Bilag-lukket_Total_Typed] (
    ...
    INSERT INTO [ode].[Bilag-lukket_Total_Backup] (
        [Intervalnummer],
    [Recordnummer],
    [Afskrivningsårsag],
    [Afskrivningsdato],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[Bilag-lukket_Total_Staging];
    ...
    INSERT INTO [ode].[Bilag-lukket_Total_Typed] (
        [Intervalnummer],
    [Recordnummer],
    [Afskrivningsårsag],
    [Afskrivningsdato],
    ...
    INSERT INTO [ode].[Bilag-lukket] ([Intervalnummer], [Recordnummer], [Afskrivningsårsag], [Afskrivningsdato], [Aftaleindhold], [Aftalekonto], [Aftalekontotype], [Aftalenummer], [Aftalestatus], [Aftaletype], [Antal_poster], [Bankafregningskonto], [Beløb_intern_valuta], [Beløb], [BevillAnsvarssted], [Bevillingsposition], [Bevillingsprogram], [Bilagsdato], [Bilagsnummer], [Bilagstype_markering], [BogfDato_udligning], [Bogføringsdato], [Bortposteringsårsag], [Dato-ID], [Deltransaktion], [Firmakode], [Forretningspartner], [Fra], [Funktionsområde], [Henstand_til], [Hovedtransaktion], [Identifikation], [Indbetalingstype], [Indholdsart], [Kapitalmidler], [Klient], [Kommune_kode], [Kredit_oprindelses_dato], [Landenøgle], [Nettoforfald], [Original-FI-område], [Position], [Postnummer], [Referencebilagsnr], [Registreringsdato], [Rykkeniveau], [Rykkeprocedure], [SBS_dokumentnummer], [Sorteringsbetegnelse], [Statistiknøgle], [Til], [Tilbageført_via], [Udligning_kredit_oprindelse], [Udligning], [Udligningsårsag], [Udligningsbeløb], [Udligningsbilag], [Udligningsdato], [Udligningsstatus], [Udligningsvaluta], [Underapplikation], [Valørdato_udligning], [Valuta], [export_date], [file_origin], [row_number], [etl_version])
    SELECT [Intervalnummer], [Recordnummer], [Afskrivningsårsag], [Afskrivningsdato], [Aftaleindhold], [Aftalekonto], [Aftalekontotype], [Aftalenummer], [Aftalestatus], [Aftaletype], [Antal_poster], [Bankafregningskonto], [Beløb_intern_valuta], [Beløb], [BevillAnsvarssted], [Bevillingsposition], [Bevillingsprogram], [Bilagsdato], [Bilagsnummer], [Bilagstype_markering], [BogfDato_udligning], [Bogføringsdato], [Bortposteringsårsag], [Dato-ID], [Deltransaktion], [Firmakode], [Forretningspartner], [Fra], [Funktionsområde], [Henstand_til], [Hovedtransaktion], [Identifikation], [Indbetalingstype], [Indholdsart], [Kapitalmidler], [Klient], [Kommune_kode], [Kredit_oprindelses_dato], [Landenøgle], [Nettoforfald], [Original-FI-område], [Position], [Postnummer], [Referencebilagsnr], [Registreringsdato], [Rykkeniveau], [Rykkeprocedure], [SBS_dokumentnummer], [Sorteringsbetegnelse], [Statistiknøgle], [Til], [Tilbageført_via], [Udligning_kredit_oprindelse], [Udligning], [Udligningsårsag], [Udligningsbeløb], [Udligningsbilag], [Udligningsdato], [Udligningsstatus], [Udligningsvaluta], [Underapplikation], [Valørdato_udligning], [Valuta], [export_date], [file_origin], [row_number], [etl_version] FROM new_data;
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[Bilag-lukket_Total_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[Bilag-lukket_Total_Staging];
    GO
