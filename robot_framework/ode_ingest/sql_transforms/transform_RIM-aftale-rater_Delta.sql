    ...
    -- ============================================================
    -- Pipeline Script for RIM-aftale-rater (Delta)
    -- Source:  RIM-aftale-rater_Delta_Staging
    -- Targets: RIM-aftale-rater_Delta_Backup, RIM-aftale-rater_Delta_Typed, RIM-aftale-rater
    ...
    IF OBJECT_ID('[ode].[RIM-aftale-rater_Delta_Backup]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[RIM-aftale-rater_Delta_Backup] (
    ...
    IF OBJECT_ID('[ode].[RIM-aftale-rater_Delta_Typed]', 'U') IS NULL
    BEGIN
        CREATE TABLE [ode].[RIM-aftale-rater_Delta_Typed] (
    ...
    INSERT INTO [ode].[RIM-aftale-rater_Delta_Backup] (
        [Ændret_den],
    [Aftale],
    [Aftalekonto],
    [Aftalekontotype],
    ...
    [row_number],
    [etl_version]
    FROM [ode].[RIM-aftale-rater_Delta_Staging];
    
    GO
    
    
    -- 2. TYPED: Transform and insert (No PK defined)
    INSERT INTO [ode].[RIM-aftale-rater_Delta_Typed] (
        [Ændret_den],
    [Aftale],
    [Aftalekonto],
    [Aftalekontotype],
    ...
    SELECT 
        ...
        (SELECT COUNT(*) FROM [ode].[RIM-aftale-rater_Delta_Staging]) as source_rows,
    ...
    DROP TABLE [ode].[RIM-aftale-rater_Delta_Staging];
    GO
